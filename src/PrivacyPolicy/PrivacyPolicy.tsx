    ...
    return (
        <div style={{ width: '100%', justifyContent: 'center', display: 'flex', overflow: 'auto' }}>
            <div style={{ width: '80%' }}>
                ...
                This Privacy Policy is prepared by Masterpiece Music (“We”) are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us.
                ...
                <Typography variant="body1">
                Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to masterpiecemusicbusiness@gmail.com
                </Typography>
